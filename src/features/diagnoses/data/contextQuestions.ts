...
export const CONTEXT_QUESTIONS: readonly DiagnosisQuestion[] = [
  ...
  },
  {
    ...
    tooltip: "Hamle önerilerini bütçenize göre kişiselleştirmek için kullanılır. Skoru etkilemez.",
    options: [
      { value: "none",        label: "Düzenli bir bütçemiz yok" },
  ...
  },
  {
    ...
    tooltip: "Mevcut çalışma durumunuzu seçin. Görüşme brifingini şekillendirir.",
    options: [
      { value: "none",         label: "Hayır, ilk kez profesyonel destek arıyoruz" },
      { value: "active",       label: "Evet, aktif çalışıyoruz" },
      { value: "discontinued", label: "Çalıştık, devam etmedik" },
      { value: "inhouse",      label: "İçeride ekibimiz var" },
    ],
  },
] as const;
